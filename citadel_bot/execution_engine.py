...
class ExecutionEngine:
    ...
    def _sync_positions_and_pnl(self):
        ...
        for ticket in closed_tickets:
            ...
            if self._risk_manager is not None:
                ...
                self._risk_manager.position_closed()
            self._append_ledger_row(
                ...
                realized_pnl=pnl,
                status="closed",
                note=f"Position closed, opened_at={state.get('opened_at_utc', '')}",
            )
    ...
    def _check_trailing_stops(self):
        ...
        for sym, bracket in list(self._bracket_groups.items()):
            ...
            asyncio.create_task(
                self._move_stop_to_breakeven(sym, bracket.tp2_ticket, bracket.entry_price, take_profit)
            )
    ...
    def _append_ledger_row(
        ...
        if self._db_available:
            ...
            asyncio.create_task(self._log_trade_to_database(trade_data, sym))
